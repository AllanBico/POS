<template>
  <div>
    <a-modal v-model:open="open" title="Add Warehouse" @ok="handleOk" @cancel="handleCancel" ok-text="Submit"
             cancel-text="Cancel">
    ...
    <a-modal v-model:open="edit_open" title="Edit User" @ok="handleOk" @cancel="handleCancel" ok-text="Submit"
             cancel-text="Cancel">
      <warehouse-edit-modal @submit-success="handleSubmitSuccess" :warehouse_id="warehouse_id"></warehouse-edit-modal>
      <template #footer>
      </template>
    </a-modal>
  </div>
      ...
      >
        ...
        <template #bodyCell="{ column, text, record }">
          <template v-if="column.dataIndex === 'operation'">
            ...
            <a-popconfirm
                v-if="warehouseStore.warehouses.length"
...
console.log("warehouseStore.warehouses", warehouseStore.warehouses)
const columns = [
  {
    title: 'Name',
    dataIndex: 'name',
...
const onDelete = async key => {
  await warehouseStore.deleteWarehouse(key)
  console.log("deleted", key)
};
const onEdit = async key => {
  console.log("edit", key)
  warehouse_id = parseInt(key)
  console.log("user_id", warehouse_id)
