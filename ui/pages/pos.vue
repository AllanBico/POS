      ...
      <a-col :span="16">
        <a-layout-header class="header">
          <div class="header-content">
            ...
            <a-input-search v-model:value="searchQuery" placeholder="Search all products here..." class="search-input" />
        ...
        <!-- Product List -->
        <a-row :gutter="[16, 16]">
          <a-col v-for="item in filteredProducts" :key="item.name" :xs="24" :sm="12" :md="8" :lg="6" :xl="4">
