<template>
  <div>
    <a-modal v-model:open="open" title="Add Expense Category" @ok="handleOk" @cancel="handleCancel" ok-text="Submit"
             cancel-text="Cancel">
    ...
    <a-modal v-model:open="edit_open" title="Edit User" @ok="handleOk" @cancel="handleCancel" ok-text="Submit"
             cancel-text="Cancel">
      <expense-category-edit-modal @submit-success="handleSubmitSuccess" :category_id="category_id"></expense-category-edit-modal>
      <template #footer>
      </template>
    </a-modal>
  </div>
  ...
  <div class="coupons-container">
    <a-card title="Categories" bordered={false}>
      ...
      <a-table
          :columns="columns"
          :data-source="categoryStore.expenseCategories"
      ...
      >
        ...
        <template #bodyCell="{ column, text, record }">
          <template v-if="column.dataIndex === 'operation'">
            ...
            <a-popconfirm
                v-if="categoryStore.expenseCategories.length"
...
console.log("categoryStore.categories", categoryStore.expenseCategories)
const columns = [
  {
    title: 'Name',
    dataIndex: 'name',
...
const onDelete = async key => {
  await categoryStore.deleteExpenseCategory(key)
